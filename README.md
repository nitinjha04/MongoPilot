...
```bash
git clone https://github.com/nitinjha04/MongoPilot
cd MongoPilot
npm install
npm run dev
```
...
Made with ❤️ by [nitin](https://github.com/nitinjha04)
[GitHub Repository](https://github.com/nitinjha04/MongoPilot)
